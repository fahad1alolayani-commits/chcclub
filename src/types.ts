...
export const translations: Record<"ar" | "en", LanguagePack> = {
  ...
  ar: {
    ...
    aboutUsText: "نادي صحة المجتمع نادٍ طلابي في جامعة الملك سعود، تابع لعمادة شؤون الطلاب، يهتم بتعزيز الصحة المجتمعية ونشر الوعي الصحي من خلال مبادرات وبرامج توعوية هادفة.",
    visionTitle: "رؤيتنا",
