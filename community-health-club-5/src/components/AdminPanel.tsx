          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-slate-500 leading-relaxed max-w-xl">
                عند الاتصال وتصدير البيانات، سيقوم النادي بإنشاء ملف قوقل شيت باسم <strong>"طلبات انضمام نادي صحة المجتمع"</strong> بمجلد Drive الخاص بك وتصدير كافة الأسماء الجديدة إليه تلقائياً.
              </p>
              {syncStatusMsg && (
