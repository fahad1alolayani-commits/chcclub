                  ...
                  <div className="flex items-start gap-3 flex-row-reverse text-right lg:flex-row lg:text-left justify-start">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-slate-500 leading-relaxed mt-1">
                        تسمح لك الصلاحية باستيراد الأسماء المسجلة غير المزمنة وإنشاء جدول بيانات مبرمج باسم <strong className="text-emerald-700">"طلبات انضمام نادي صحة المجتمع"</strong> بمجلد قوقل درايف الخاص بالكلية.
                      </p>
                      {syncStatusMsg && (
